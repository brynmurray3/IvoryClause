...
.brand { font-size: 9pt; letter-spacing: 0.2em; text-transform: uppercase; color: #ff4500; margin-bottom: 8px; font-weight: 500; }
...
.section-title { font-size: 8pt; font-weight: 500; letter-spacing: 0.22em; text-transform: uppercase; color: #ff4500; margin-bottom: 14px; padding-bottom: 6px; border-bottom: 1px solid #eee; }
...
.highlight { background: #fff8f5; border-left: 3px solid #ff4500; padding: 10px 16px; margin: 12px 0; font-size: 10pt; }
